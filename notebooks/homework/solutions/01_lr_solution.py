"""
01 — Linear Regression from scratch.   [SOLUTION]
...
No scikit-learn, no statsmodels — the point is to see every step.
    ...
    uv run solutions/01_lr_solution.py --plot     # save a PNG of fit + loss curve
    uv run solutions/01_lr_solution.py --report   # write a markdown lab report
...
def fit_gradient_descent(X_design, y, lr=LEARNING_RATE, n_iter=N_ITERATIONS):
    ...
    for _ in range(n_iter):
        history.append(mse(y, predict(X_design, beta)))
