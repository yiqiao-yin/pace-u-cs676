"""
02 — Logistic Regression from scratch.   [SOLUTION]

Binary classification by gradient descent on the log-loss. Pure numpy.

    uv run solutions/02_logreg_solution.py
    uv run solutions/02_logreg_solution.py --plot
    uv run solutions/02_logreg_solution.py --report
