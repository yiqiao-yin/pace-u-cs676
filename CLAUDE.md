...
- **The live Claude paths have never been executed** — `credibility.llm_opinion`, `main.ask_claude`, and `ClaudeLLM.complete` are written against the SDK but no billed request has been made. This is flagged at each call site and in both project READMEs. Do not describe them as tested.
